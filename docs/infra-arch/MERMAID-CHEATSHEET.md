...
gantt
  ...
  section Phase 1 - Setup
    Provision GKE cluster     :p1a, 2025-01-06, 3d
...
timeline
  ...
  section V1
    2025-01 : Project kickoff
             : Architecture design
    2025-02 : V1 backend complete
             : V1 frontend complete
             : Tagged v1.0.0
  section V2
    2025-03 : Dark luxury theme
             : Motion animations
             : Split pane layout
  section Infra
    2025-04 : K8s learning docs
             : GKE deployment
             : CI/CD pipeline
```
...
journey
  ...
  section AI Briefing
    Click Generate: 5: Doctor
    Wait for AI: 2: Doctor
    Read briefing: 5: Doctor
    Review flags: 5: Doctor
```
