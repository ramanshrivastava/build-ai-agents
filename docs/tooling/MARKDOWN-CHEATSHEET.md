...
- [Markdown Cheatsheet](#markdown-cheatsheet)
  - [The Story of Markdown](#the-story-of-markdown)
    - [Who Created It and Why](#who-created-it-and-why)
    - [The Key Insight](#the-key-insight)
    - [How It Spread](#how-it-spread)
    - [Why Markdown Became the AI Agent Format](#why-markdown-became-the-ai-agent-format)
    - [Markdown Across AI Tools](#markdown-across-ai-tools)
    - [Why Markdown Won Over Alternatives](#why-markdown-won-over-alternatives)
  - [Quick Start (5 Rules)](#quick-start-5-rules)
    - [Rule 1: Headers create hierarchy (`#` through `######`)](#rule-1-headers-create-hierarchy-through)
    - [Rule 2: Blank lines separate blocks](#rule-2-blank-lines-separate-blocks)
    - [Rule 3: Indentation matters in lists (2 or 4 spaces)](#rule-3-indentation-matters-in-lists-2-or-4-spaces)
    - [Rule 4: Backticks for code (`` ` `` inline, ` ``` ` blocks)](#rule-4-backticks-for-code-inline-blocks)
    - [Rule 5: One blank line before and after code blocks and lists](#rule-5-one-blank-line-before-and-after-code-blocks-and-lists)
  - [1. Headers](#1-headers)
    - [ATX-style headers (standard)](#atx-style-headers-standard)
    - [Setext-style headers (alternative for H1 and H2 only)](#setext-style-headers-alternative-for-h1-and-h2-only)
    - [Key rules](#key-rules)
  - [2. Text Formatting](#2-text-formatting)
    - [Inline formatting](#inline-formatting)
    - [Alternative syntax](#alternative-syntax)
    - [Subscript and superscript (HTML)](#subscript-and-superscript-html)
    - [Keyboard keys (HTML)](#keyboard-keys-html)
    - [Highlight (GFM — limited support)](#highlight-gfm-limited-support)
  - [3. Lists](#3-lists)
    - [Unordered lists](#unordered-lists)
    - [Ordered lists](#ordered-lists)
    - [Nested lists](#nested-lists)
    - [Task lists (GFM)](#task-lists-gfm)
    - [Definition lists (limited support)](#definition-lists-limited-support)
  ...
  - [4. Links and Images](#4-links-and-images)
    ...
    - [Autolinks](#autolinks)
    - [Images](#images)
    - [Linked images (image that is also a link)](#linked-images-image-that-is-also-a-link)
    - [Relative paths](#relative-paths)
    - [Key rules](#key-rules-2)
  - [5. Code](#5-code)
    - [Inline code](#inline-code)
    - [Fenced code blocks](#fenced-code-blocks)
    - [Common language identifiers](#common-language-identifiers)
    - [Diff syntax highlighting](#diff-syntax-highlighting)
    - [Indented code blocks (alternative)](#indented-code-blocks-alternative)
    - [Nested code blocks (quad backticks)](#nested-code-blocks-quad-backticks)
    - [Key rules](#key-rules-3)
  - [6. Blockquotes and Callouts](#6-blockquotes-and-callouts)
    - [Basic blockquotes](#basic-blockquotes)
    - [Nested blockquotes](#nested-blockquotes)
    - [Multi-paragraph blockquotes](#multi-paragraph-blockquotes)
    - [GitHub alert syntax (GFM)](#github-alert-syntax-gfm)
    - [Content inside blockquotes](#content-inside-blockquotes)
    - [Key rules](#key-rules-4)
  - [7. Tables](#7-tables)
    - [Basic table](#basic-table)
    - [Column alignment](#column-alignment)
    - [Formatting in cells](#formatting-in-cells)
    - [Compact syntax](#compact-syntax)
    - [Key rules](#key-rules-5)
  ...
  - [9. HTML in Markdown](#9-html-in-markdown)
    ...
    - [When to use HTML vs Markdown](#when-to-use-html-vs-markdown)
    - [Key rules](#key-rules-6)
  - [10. Footnotes](#10-footnotes)
    - [Inline footnotes](#inline-footnotes)
    - [Named footnotes](#named-footnotes)
    - [Key rules](#key-rules-7)
  - [11. Escaping Special Characters](#11-escaping-special-characters)
    - [Backslash escapes](#backslash-escapes)
    - [Characters that need escaping](#characters-that-need-escaping)
    - [Alternative: use code backticks](#alternative-use-code-backticks)
  - [12. CommonMark vs GFM vs MDX](#12-commonmark-vs-gfm-vs-mdx)
    - [CommonMark — the standard](#commonmark-the-standard)
    - [GitHub Flavored Markdown (GFM)](#github-flavored-markdown-gfm)
    - [MDX — Markdown + JSX](#mdx-markdown-jsx)
    - [What to use when](#what-to-use-when)
  - [13. Markdown for AI Agent Configuration](#13-markdown-for-ai-agent-configuration)
    - [Why structure matters for agents](#why-structure-matters-for-agents)
    - [Structural patterns that help agents](#structural-patterns-that-help-agents)
    - [Anti-patterns for agent configs](#anti-patterns-for-agent-configs)
    - [CLAUDE.md template pattern](#claudemd-template-pattern)
    - [Cross-tool patterns](#cross-tool-patterns)
  - [14. Markdown Tooling](#14-markdown-tooling)
    - [Neovim / LazyVim](#neovim-lazyvim)
    - [VS Code](#vs-code)
    - [Linting](#linting)
    - [Formatting](#formatting)
    - [Document conversion](#document-conversion)
  - [Appendix: Emoji in Markdown](#appendix-emoji-in-markdown)
    - [Shortcodes (GitHub)](#shortcodes-github)
    - [Unicode emoji (universal)](#unicode-emoji-universal)
    - [Common emoji for documentation](#common-emoji-for-documentation)
  - [Appendix: Line Breaks](#appendix-line-breaks)
    - [Paragraph break (blank line)](#paragraph-break-blank-line)
    - [Hard line break (two trailing spaces or `<br>`)](#hard-line-break-two-trailing-spaces-or-br)
    - [Soft line break (single newline)](#soft-line-break-single-newline)
